    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordered_date', models.DateTimeField(default=datetime.datetime(2021, 11, 19, 20, 24, 53, 281460, tzinfo=utc), verbose_name='order date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(default=orders.generate_code.random_string, max_length=100, unique=True, verbose_name='discount code')),
